...
class TwoStacks {
    ...
    public void push2(Integer value) {
        if (next2 < stacksStore.length) {
            stacksStore[next2++] = value;
        }
    }
