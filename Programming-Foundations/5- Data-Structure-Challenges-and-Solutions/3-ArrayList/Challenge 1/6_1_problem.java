...
class MyArrayList {
    ...
    public MyArrayList(int initialCapacity) {
        data = new int[initialCapacity >= 0 ? initialCapacity : 0];
        _size = 0;
    }
    ...
    private void checkSpace() {
        ...
        int[] newArr = new int[data.length == 0 ? 1 : data.length * 2];
    ...
    public int remove() throws IndexOutOfBoundsException {
        ...
        int removedElement = data[_size - 1];
        _size--;
...
class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Add first element to array list");
        arrList.add(10);
